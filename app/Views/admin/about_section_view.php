            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">About Us Section </h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
							...
							<form name="banner" action="<?= base_url('admin/about_update');?>" method="post" enctype="multipart/form-data">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">About us Section Update Here</h6>
                                </div>
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">About Us Title </h4>
                                     <input type="text" name="title" value="<?= $about_title;?>">
                                    <br/>
									<br/>
									 <h4 class="small font-weight-bold">Youtube Link</h4>
									 <input type="text" name="link" value="<?= $youtube_link;?>">
									 <br/>
									 <br/>
									 <h4 class="small font-weight-bold">Number Phone</h4>
									 <input type="text" name="mobile" value="<?= $phone;?>">
									
									<br/>
									<br/>
                                    <h4 class="small font-weight-bold">About Description</h4>
                                   <textarea id="description" name="description" rows="4" cols="50"><?= $about_description;?> </textarea>
                                   
									<br/>
									<br/>
									 <h4 class="small font-weight-bold">Upload Image 665 x 766 Diamention </h4>
									 <input type="file" name="file" value="">
									 <br/>
									<br/>
									 <h4 class="small font-weight-bold">Upload Image Thumb  403 x 302 Diamention</h4>
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="<?php echo base_url();?>/public/uploaded_img/<?=$section_img;?>" alt="...">
                                    </div>
                                    
                                </div>
								
								<div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Photo Of Thumb</h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="<?php echo base_url();?>/public/uploaded_img/<?=$video_thumb;?>" alt="...">
                                    </div>
