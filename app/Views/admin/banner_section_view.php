            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Banner Section </h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
							...
							<form name="banner" action="<?= base_url('admin/banner_update');?>" method="post" enctype="multipart/form-data">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Projects</h6>
                                </div>
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">Banner Title </h4>
									...
									<br/>
									<br/>
                                    <h4 class="small font-weight-bold">Banner Description</h4>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Photo Of Banner</h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="<?php echo base_url();?>/public/uploaded_img/<?=$banner_photo;?>" alt="...">
                                    </div>
