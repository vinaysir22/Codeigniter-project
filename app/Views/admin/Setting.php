    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url();?>/admin/profile">
                ...
                <div class="sidebar-brand-text mx-3">Website Admin </div>
            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                <form name="" action="<?=base_url('/admin/setting_udpate');?>" method="post" enctype="multipart-form-data">
                                    ...
                                    <br/>
                                    <br/>
                                    <h4 class="small font-weight-bold">Phone </h4>
                                    <input type="text" name="phone" value="<?= $phone;?>">
                                    <br/>
                                    <br/>
                                    <h4 class="small font-weight-bold">Update Information </h4>
